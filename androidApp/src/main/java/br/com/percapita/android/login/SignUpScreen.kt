package net.azurewebsites.percapita.android.login
...
import net.azurewebsites.percapita.android.PercapitaTheme
    ...
    PercapitaTheme() {
        Surface(modifier = Modifier.fillMaxSize()) {
            Column(
                ...
                Text(text = "Pronto para colocar sua renda em ordem?", fontSize = 19.sp,
                    fontWeight = FontWeight.Light)
                Text(text = "Preencha os dados abaixo e crie sua conta!", fontSize = 19.sp,
                    fontWeight = FontWeight.Light)
                Spacer(modifier = Modifier.height(50.dp))
                Text(text = "Nome", textAlign = TextAlign.Left, modifier = Modifier.fillMaxWidth(0.9f))
                OutlinedTextField(value = name.value, onValueChange = {name.value = it},
                    label = {Text(text = "Nome")}, modifier = Modifier.fillMaxWidth(0.9f))
                Spacer(modifier = Modifier.height(15.dp))

                Text(text = "E-mail", textAlign = TextAlign.Left, modifier = Modifier.fillMaxWidth(0.9f))
                ...
                Text(text = "Senha", textAlign = TextAlign.Left, modifier = Modifier.fillMaxWidth(0.9f))
                ...
                Text(text = "Confirme sua senha", textAlign = TextAlign.Left, modifier = Modifier.fillMaxWidth(0.9f))
